...
export class CreateUsuarioDto {
    ...
    @ApiProperty({ example: 'senha123', description: 'Senha com 6 a 20 caracteres' })
    @IsString()
    @Length(6, 20, { message: 'A senha deve ter entre 6 e 20 caracteres.' })
    password: string;

    @ApiProperty({ example: '11999999999', description: 'Telefone com 10 ou 11 dígitos' })
    @IsString()
    ...
    endereco: string;
    @ApiProperty({ enum: ['admin', 'paciente', 'profissional', 'funcionario'], description: 'Tipo de usuário' })
